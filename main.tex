...
%Within Astronomy, funding for DRI, and in particular the software layer,  from CFI, CANARIE, and other sources and contributions of hardware and support from Compute Canada (and its regional centres) and other sources need to be managed by a consortium of university researchers via a national Astronomy-DRI organization (such as CANFAR) in partnership with CADC/NRC.  
